...
<section class="w-full h-screen py-16 px-16 flex items-center justify-center">
    <div class="h-full w-2/5 bg-tertiary py-8 px-8 rounded-2xl flex flex-col items-center">
        ...
        <div class="w-full h-[90%] bg-dark rounded-2xl flex flex-col items-center justify-center py-16 px-20">
            <div class="w-full h-auto overflow-auto">
                <div class="w-full h-full px-2">
                    ...
                    <form action="/dashboard/changes/{{ $employee->id }}" method="post">
                        @csrf
                        ...
                        <button type="submit" class="gradcolor w-full text-white rounded-lg py-2 px-4 mt-4">Change</button>
                    </form>
                </div>
            </div>
        </div>
