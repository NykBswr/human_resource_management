...
<section class="w-full h-screen py-10 px-10 flex items-center justify-center">
    <div class="w-[30%] h-[80%] bg-tertiary py-8 px-8 rounded-2xl flex flex-col items-center">
        ...
        <div class="bg-secondary w-full h-full flex flex-col items-center overflow-x-auto p-20 rounded-lg justify-center">
            <form method="post" action="/PayrollandBenefit/applyrequest" class="w-full" enctype="multipart/form-data">
                @csrf
                ...
                <div class="w-full mt-4">
                    ...
                    <input type="text" class="bg-tertiary rounded-md text-primary flex flex-start gap-3 mt-4 w-full px-6 py-3 " name="request_amount" value="{{ old ('request_amount') }}"/>
