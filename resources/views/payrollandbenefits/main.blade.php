    ...
    <div class="w-full h-full bg-tertiary py-5 px-20 rounded-2xl flex flex-col items-center" id="main2">
        ...
        @can('hr')
            <div class="bg-dark flex rounded-full text-white ml-auto -mt-9">
                <a href="{{ request()->fullUrlWithQuery(['type_filter' => 'payroll']) }}" class="{{ ($typeFilter === '' || request()->path() === 'PayrollandBenefit' && $typeFilter !== 'benefit') ? 'gradcolor' : 'bg-dark' }} rounded-full py-2 px-7">Payroll</a>
                ...
                @can('hr')
                    <div class="flex justify-center mt-2 mb-5">
                        <div class="bg-dark flex rounded-full text-white ml-auto">
                            <a href="{{ request()->fullUrlWithQuery(['type_filter2' => 'benefitlist']) }}" class="{{ ($typeFilter === '' || request()->path() === 'PayrollandBenefit' && $typeFilter2 !== 'employeebenefits') ? 'gradcolor' : 'bg-dark' }} rounded-full py-2 px-7">Benefits List</a>
                            <a href="{{ request()->fullUrlWithQuery(['type_filter2' => 'employeebenefits']) }}" class="{{ (request()->path() === 'PayrollandBenefit' && $typeFilter2 === 'employeebenefits') ? 'gradcolor' : 'bg-dark' }} rounded-full py-2 px-7">Employee Benefits</a>
                        </div>
                    </div>
                @endcan
            @endif
