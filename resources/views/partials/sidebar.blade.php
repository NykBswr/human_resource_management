    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <div class="w-full px-12">
            ...
            <a href="/attendance" class="{{ Request::is('attendance') ? 'text-primary' : 'text-slate-500' }}">
                <h1 class="w-[100%] py-5 px-16 flex justify-start mb-5 text-xl rounded-md bg-tertiary hover:text-white hover:bg-opacity-50">Atendance</h1>
            </a>
            ...
            <a href="/facility" class="{{ Request::is('facility') ? 'text-primary' : 'text-slate-500' }}">
                <h1 class="w-[100%] py-5 px-16 flex justify-start mb-5 text-xl rounded-md bg-tertiary hover:text-white hover:bg-opacity-50">Facility</h1>
            </a>
            <a href="/offdays" class="{{ Request::is('offdays') ? 'text-primary' : 'text-slate-500' }}">
                <h1 class="w-[100%] py-5 px-16 flex justify-start mb-5 text-xl rounded-md bg-tertiary hover:text-white hover:bg-opacity-50">Off Days</h1>
            </a>

            @can('atasan')
            <a href="/userlist" class="{{ Request::is('userlist') ? 'text-primary' : 'text-slate-500' }}">
                <h1 class="w-[100%] py-5 px-16 flex justify-start mb-5 text-xl rounded-md bg-tertiary hover:text-white hover:bg-opacity-50">Employee List</h1>
            </a>
            @endcan
        </div>
    </div>
